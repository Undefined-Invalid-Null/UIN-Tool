...
import com.UIN.Tool.app.api.file.FileReceiverActivity;
import com.UIN.Tool.app.terminal.TermuxActivityRootView;
import com.UIN.Tool.app.terminal.TermuxTerminalSessionActivityClient;
import com.UIN.Tool.app.terminal.io.TermuxTerminalExtraKeys;
import com.UIN.Tool.shared.activities.ReportActivity;
import com.UIN.Tool.shared.activity.ActivityUtils;
import com.UIN.Tool.shared.activity.media.AppCompatActivityUtils;
...
import com.UIN.Tool.app.activities.HelpActivity;
...
import com.UIN.Tool.app.terminal.TermuxSessionsListViewController;
import com.UIN.Tool.app.terminal.io.TerminalToolbarViewPager;
import com.UIN.Tool.app.terminal.TermuxTerminalViewClient;
import com.UIN.Tool.shared.termux.extrakeys.ExtraKeysView;
import com.UIN.Tool.shared.termux.interact.TextInputDialogUtils;
                ...
                if(PermissionUtils.checkAndRequestLegacyOrManageExternalStoragePermission(
                    ...
                    if (isPermissionCallback)
                        Logger.logInfoAndShowToast(TermuxActivity.this, LOG_TAG,
                            getString(com.UIN.Tool.shared.R.string.msg_storage_permission_granted_on_request));

                    TermuxInstaller.setupStorageSymlinks(TermuxActivity.this);
                } else {
                    if (isPermissionCallback)
                        Logger.logInfoAndShowToast(TermuxActivity.this, LOG_TAG,
                            getString(com.UIN.Tool.shared.R.string.msg_storage_permission_not_granted_on_request));
                }
            }
        }.start();
    }
