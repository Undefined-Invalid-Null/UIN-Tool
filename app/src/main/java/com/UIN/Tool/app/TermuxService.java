...
import com.UIN.Tool.app.event.SystemEventReceiver;
import com.UIN.Tool.app.terminal.TermuxTerminalSessionActivityClient;
import com.UIN.Tool.app.terminal.TermuxTerminalSessionServiceClient;
import com.UIN.Tool.shared.termux.plugins.TermuxPluginUtils;
import com.UIN.Tool.shared.data.IntentUtils;
import com.UIN.Tool.shared.net.uri.UriUtils;
import com.UIN.Tool.shared.errors.Errno;
import com.UIN.Tool.shared.shell.ShellUtils;
...
import com.UIN.Tool.shared.termux.shell.TermuxShellUtils;
import com.UIN.Tool.shared.termux.TermuxConstants;
import com.UIN.Tool.shared.termux.TermuxConstants.TERMUX_APP.TERMUX_ACTIVITY;
...
import com.UIN.Tool.shared.termux.shell.command.runner.terminal.TermuxSession;
import com.UIN.Tool.shared.termux.terminal.TermuxTerminalSessionClientBase;
import com.UIN.Tool.shared.logger.Logger;
import com.UIN.Tool.shared.notification.NotificationUtils;
import com.UIN.Tool.shared.android.PermissionUtils;
...
import com.UIN.Tool.shared.shell.command.ExecutionCommand.ShellCreateMode;
import com.UIN.Tool.terminal.TerminalEmulator;
...
public final class TermuxService extends Service implements AppShell.AppShellClient, TermuxSession.TermuxSessionClient {
     ...
     * the results forever like in case of commands started by com.UIN.Tool:Tasker or RUN_COMMAND intent,
     ...
     * be used, like in Tasker for the com.UIN.Tool:Tasker actions.
     *
    ...
    private synchronized void killAllTermuxExecutionCommands() {
        ...
        for (int i = 0; i < pendingPluginExecutionCommands.size(); i++) {
            ...
            if (!executionCommand.shouldNotProcessResults() && executionCommand.isPluginExecutionCommandWithPendingResult()) {
                if (executionCommand.setStateFailed(Errno.ERRNO_CANCELLED.getCode(), this.getString(com.UIN.Tool.shared.R.string.error_execution_cancelled))) {
