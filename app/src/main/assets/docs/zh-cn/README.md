...
- [15.3 形状配置](#153-形状配置)
- [15.4 特效配置](#154-特效配置v560-更新)
- [15.5 多语言支持](#155-多语言支持v560-新增)
...
| 特效 | 说明 |
|------|------|
| 渐变背景 | 全局渐变背景，支持单选/多选模式与 6 方向设置（v5.3.0 新增） |
| 玻璃效果 | 毛玻璃质感的 UI 组件（半透明背景、无边框、无阴影） |
| 新拟态风格 | 柔和凹凸光影效果的 UI 组件（v5.6.0 新增，与玻璃效果互斥） |
| 波纹效果 | 点击波纹反馈开关 |
| 半透明效果透明度 | 玻璃效果 / 新拟态效果的 alpha 透明度调节（v5.6.0 新增） |

### 15.5 多语言支持（v5.6.0 新增）

支持在应用内直接切换显示语言（中文/英文等），无需更改系统语言。语言配置参与保存/重置/导出/导入。
