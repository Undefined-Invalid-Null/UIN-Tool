...
import com.UIN.Tool.shared.reflection.ReflectionUtils;
...
import com.UIN.Tool.shared.termux.TermuxConstants.TERMUX_APP;
...
public class TermuxUtils {
     ...
     *
     * If your third-party app is targeting sdk `30` (android `11`), then it needs to add `com.UIN.Tool`
     * package to the `queries` element or request `QUERY_ALL_PACKAGES` permission in its
     * `AndroidManifest.xml`. Otherwise it will get `PackageSetting{...... com.UIN.Tool/......} BLOCKED`
     ...
     * <manifest
     *     <queries>
     *         <package android:name="com.UIN.Tool" />
     *    </queries>
     * </manifest>
     * }
     *
    ...
    /**
     * Check if com.UIN.Tool:API app is installed and enabled. This can be used by external apps that don't
     * share `sharedUserId` with the com.UIN.Tool:API app.
     *
     * @param context The context for operations.
    ...
    public static String geAPTInfoMarkdownString(@NonNull final Context context) {
        ...
        InputStream inputStream = context.getResources().openRawResource(com.UIN.Tool.shared.R.raw.apt_info_script);
        try {
