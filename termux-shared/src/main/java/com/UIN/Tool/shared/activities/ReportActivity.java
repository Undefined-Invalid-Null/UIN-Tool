package com.UIN.Tool.shared.activities;
 ...
 * {@code `<activity android:name="com.UIN.Tool.shared.activities.ReportActivity" android:theme="@style/Theme.AppCompat.TermuxReportActivity" android:documentLaunchMode="intoExisting" />` }
 * and
 * {@code `<receiver android:name="com.UIN.Tool.shared.activities.ReportActivity$ReportActivityBroadcastReceiver"  android:exported="false" />` }
